...
public class Ask2 extends AppCompatActivity implements View.OnClickListener {
    RadioButton btn_yes;
    RadioButton btn_no;
    RadioGroup radio;
    ImageView iv_back;
        ...
        ParseQuery.getQuery(tableName).whereEqualTo("userID", ParseUser.getCurrentUser())
                .getFirstInBackground(new GetCallback<ParseObject>() {
                    ...
                    public void done(ParseObject obj1, final ParseException e) {
                        if (e == null) {
                            obj1.put("involveGambling", num);
                            obj1.saveInBackground(new SaveCallback() {
                                @Override
                                public void done(ParseException e) {
                                    if (e == null) {
                                        Toast.makeText(Ask2.this, "Your Answer save successfully", Toast.LENGTH_SHORT).show();
                                        td.dismiss();
                                        Intent i = new Intent(Ask2.this, Ask3.class);
