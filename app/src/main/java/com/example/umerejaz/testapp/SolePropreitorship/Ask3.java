...
public class Ask3 extends AppCompatActivity implements View.OnClickListener{
    RadioButton btn_yes;
    RadioButton btn_no;
    RadioGroup radio;
    ImageView iv_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ask3);
        ...
        ParseQuery.getQuery(tableName).whereEqualTo("userID", ParseUser.getCurrentUser())
                .getFirstInBackground(new GetCallback<ParseObject>() {
                    ...
                    public void done(ParseObject obj1, final ParseException e) {
                        if (e == null) {
                            obj1.put("needFederalTax", num);
                            obj1.saveInBackground(new SaveCallback() {
                                @Override
                                public void done(ParseException e) {
                                    if (e == null) {
                                        Toast.makeText(Ask3.this, "Your Answer save successfully", Toast.LENGTH_SHORT).show();
                                        td.dismiss();
                                        Intent i = new Intent(Ask3.this, Ask4.class);
