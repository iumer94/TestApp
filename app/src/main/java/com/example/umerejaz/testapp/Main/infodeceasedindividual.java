...
public class infodeceasedindividual extends AppCompatActivity implements View.OnClickListener,AdapterView.OnItemSelectedListener{
    Button next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infodeceasedindividual);
...
public void onClick(View view) {
        if (view.getId() == next.getId()) {
            Intent i = new Intent(this, CustomerAgreement.class);
